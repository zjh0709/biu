...
if __name__ == '__main__':
    ...
    s = """事件:根据近期与经销商交流了解到的情况,公司产品在春节期间动销良好,终端需求较旺,验证公司年报数据显示的快速增长。16年公司营业收入同比+23.6%,归母净利润同比+50.4%。16年下半年开始公司销售明显放量,
        ...
        推出有机、头道原香公、窖醋等差异化产品满足消费者需求,同时推动产品结构进一步优化,实现毛利率稳步提升。市场拓展方面:公司继续巩固在西南地区传统优势,16年收入同比+23.4%,保持较快增速。在开拓全国市场上,
        ...
        产能限制将成为公司业绩持续高增长最大阻碍。从未来战略角度考虑,司此次计划发行可转债募资不超过3.56亿元,扩建年产25万吨酿造酱油、食醋生产线,将有效突破产能瓶颈,巩固和提升公司市场领先地位,彰显公司远见。    
